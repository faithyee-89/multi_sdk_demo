...
class HardwareHahaImpl : IHardware {
    companion object {
        private const val TAG = "HardwareHahaImpl"
    }
     ...
     */
    override fun init() {
        Log.d("HardwareHahaImpl", "哈哈SDK初始化")
    }
    ...
    override fun whileCheckLockState(index: Int, checkState: Int, timeout_s: Int): Boolean {
        Log.d(TAG, "haha -> whileCheckLockState: ")
        return true
    }
    ...
    override fun whileCheckDoorState(index: Int, checkState: Int, timeout_s: Int): Boolean {
        Log.d(TAG, "haha -> whileCheckDoorState: ")
        return true
    }
